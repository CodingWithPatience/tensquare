...
<div>
    ...
    <el-pagination @size-change="fetchData" @current-change="fetchData" :current-page="currentPage" :page-sizes="[5,10,20]" :page-size="10" layout="total, sizes, prev, pager, next, jumper" :total="total">
    </el-pagination>
...
export default {
    ...
    methods: {
        fetchData() {
            enterpriseApi.search(this.currentPage, this.searchMap).then(response => {
