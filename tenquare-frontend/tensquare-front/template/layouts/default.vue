            ...
            <div class="sui-navbar">
                <div class="navbar-inner">
                    ...
                    <ul class="sui-nav">
                        ...
                        <router-link tag="li" to="/friends" active-class="active"><a>交友</a></router-link>
                    ...
                    <div class="sui-nav pull-right info" v-if="user.nickName !== undefined">
                        <li><a href="/manager" target="_blank" class="notice">{{user.nickName}}</a></li>
                        <li><a @click="logout" class="notice">退出登陆</a></li>
                        <li><a href="/manager" target="_blank" class="homego"><img :src="user.image" width="50px" height="50px" alt="用户头像" /></a></li>
                    </div>
                    <div class="sui-nav pull-right info" v-if="user.nickName === undefined">
                        <li><router-link to="/login" class="notice">登陆</router-link></li>
                    </div>
                </div>
            </div>
        </div>
